        ...
        child: Column(children: [
          ...
          Expanded(
                  ...
                  InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Row(children: [
                        ...
                        Expanded(
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Text(label, style: TextStyle(fontSize: 14.5, fontWeight: FontWeight.bold, color: ink)),
                            Text(sub, style: TextStyle(fontSize: 12, color: muted)),
                          ]),
                        ),
                        Icon(Icons.chevron_right, size: 20, color: dark ? AppColors.darkFaint : AppColors.lightFaint),
                      ]),
                    ),
                  ),
              ]),
            ...
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('Tampilan', style: TextStyle(fontSize: 14.5, fontWeight: FontWeight.bold, color: ink)),
                ...
                const SizedBox(height: 8),
                Text('Mode gelap otomatis mengikuti sistem saat memilih "Auto".',
            ...
            const SizedBox(height: 12),
            Center(child: Text('NeumoAI-D v1.0.0 · Made with 💙 di Indonesia',
                style: TextStyle(fontSize: 12, color: dark ? AppColors.darkFaint : AppColors.lightFaint))),
              ],
            ),
          ),
        ]),
